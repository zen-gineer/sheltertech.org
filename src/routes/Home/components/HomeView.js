  ...
  <div className='home'>
    ...
    <section className='intiatives' id='initiatives'>
      ...
      <div className='shelter-wifi'>
        <div className='content'>
          <div className='initiative-logo' style={initiativeLogo1} />
      ...
      <div className='askdarcel'>
        <div className='content'>
          <a href='https://askdarcel.org'><div className='initiative-logo' style={initiativeLogo2} /></a>
      ...
      <div className='casey'>
        <div className='content'>
          <div className='casey-text'>
            <div className='initiative-logo' style={initiativeLogo3} />
