    ...
    <div className='content'>
      ...
      <div className='annual-report--2019'>
        <div className='wrapper'>
          ...
          <p className='annual-report--text'>Want even more details? Read the full annual report <a href='https://sheltertech.org/ShelterTech-Annual-Report-2018.pdf'>here</a>.</p>
        </div>
      </div>
