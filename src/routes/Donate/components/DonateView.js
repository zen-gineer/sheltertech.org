    ...
    <div className='content'>
      ...
      <ul className='donate--cards'>
        <li className='donate--card'>
          ...
          <h6>Supporter</h6>
          <p>2 weeks of free wifi in an emergency shelter serving up to 300 people</p>
        ...
        <li className='donate--card'>
          ...
          <h6>Donor</h6>
          <p>6 hours of valuable work experience for someone experiencing homelessness</p>
          <form action='https://www.paypal.com/cgi-bin/webscr' method='post' target='_top' id='donate-form'>
            <input type='hidden' name='cmd' value='_s-xclick' />
            <input type='hidden' name='hosted_button_id' value='K29R6HRSEDRF6' />
            <input className='donate-form-button' type='image' src={ImageDonate} border='0' name='submit' alt='PayPal - The safer, easier way to pay online!' />
        ...
        <li className='donate--card donate--card--custom'>
          ...
          <p>ShelterTech is an all-volunteer non-profit so your donations go towards services and employment opportunities for those experiencing homelessness. </p>
          <form action='https://www.paypal.com/cgi-bin/webscr' method='post' target='_top' id='donate-form'>
            <input type='hidden' name='cmd' value='_s-xclick' />
            <input type='hidden' name='hosted_button_id' value='K29R6HRSEDRF6' />
            <input className='donate-form-button' type='image' src={ImageDonate} border='0' name='submit' alt='PayPal - The safer, easier way to pay online!' />
